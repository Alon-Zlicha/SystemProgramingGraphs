...
namespace ariel
{
    ...
    void Algorithms::BFS(Graph &g, std::vector<bool> &visited, std::vector<bool> &hasPathToAll, size_t start)
    {
        std::queue<size_t> q;
        q.push(start);
        visited[start] = true;
    ...
    bool Algorithms::hasCycleDFS(Graph &g, std::vector<bool> &visited, std::vector<bool> &recStack, std::stack<size_t> &path, size_t current, size_t parent)
    {
